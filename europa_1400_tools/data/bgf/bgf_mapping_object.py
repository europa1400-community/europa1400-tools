...
from europa_1400_tools.data.bgf.bgf_polygon_mapping import BgfPolygonMapping
from europa_1400_tools.data.bgf.bgf_vertex_mapping import BgfVertexMapping
from europa_1400_tools.helpers import skip_required
